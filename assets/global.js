...
class VariantSelects extends HTMLElement {
  ...
  hideNonVariantImages() {
    const allSlideImages = document.querySelectorAll(
      `[id^="MediaGallery-${this.dataset.section}"] .slider__slide`
    )
  ...
  renderProductInfo() {
    fetch(
      ...
      .then((responseText) => {
        ...
        const destinationAddon = document.getElementById(
          `addon-${this.dataset.section}`
        )
        if (sourceAddon && destinationAddon)
          destinationAddon.innerHTML = sourceAddon.innerHTML
      })
  }
...
class VariantRadios extends VariantSelects {
  constructor() {
    ...
    this.activeImage = this.activeSlider
      .querySelector('img')
      .getAttribute('srcset')
  ...
  onSwatchHover(event) {
    ...
    if (swatchId != null) {
      ...
      this.activeSlider
        .querySelector('img')
        .setAttribute('srcset', imageVariant)
    }
  }
  ...
  onHoverOut(event) {
    this.activeSlider
      .querySelector('img')
      .setAttribute('srcset', this.activeImage)
  }
}
